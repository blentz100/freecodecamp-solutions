...
must do so through the Redux store. The unidirectional data flow makes it
...
for you in the code editor. It simply takes state as an argument and returns
state.
...
this state to hold a value of 5. If you're not familiar with default arguments,
