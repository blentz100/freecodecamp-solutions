/* Match Characters that Occur One or More TimesPassed Sometimes, you need to match
a character (or group of characters) that appears one or more times in a row.
...
between them. Finally, since there is no a in the string bcd, it wouldn't find a
match.
