...
cities.splice(3, 1); Here splice returns the string London and deletes it from
the cities array. cities will have the value ["Chicago", "Delhi", "Islamabad",
"Berlin"].
...
console.log("inputCities is: " + inputCities)

console.log("return from the function: " + nonMutatingSplice(inputCities));
