...
console.log(duck.constructor === Bird); console.log(beagle.constructor === Dog);
...
function joinBirdFraternity(candidate) { if (candidate.constructor === Bird) {
return true; } else { return false; } } Note: Since the constructor property can
be overwritten (which will be covered in the next two challenges) it’s generally
...
the constructor property, return true if the candidate is a Dog, otherwise
return false.
*/
...
let newBeagle = new Dog("Fred");
console.log(newBeagle)

joinDogFraternity(newBeagle);
